...
MODEL_DIR = "../../LLMS/TinyLlama-1.1B-Chat-v1.0-GPTQ8"
MODEL_FILENAME = "tinyllama-1.1b-intermediate-step-1431k-3t.Q8_0.gguf" #Adjust model to use here
...
def chat(
    ...
    # Get context and curriculum
    context = memory.get_context(message)
    relevant_chunks = curriculum_indexer.search(message)

    # Generate prompt
    formatted_prompt = llm_service.format_prompt(
        message=message,
        history=context,
        curriculum_chunks=relevant_chunks
    )
